    ...
    <table border="1" cellspacing="" align="center">
        <thead>
            ...
            <tr>
                ...
                <td>UKK (Ujian Kompetensi Keahlian)</td>
                <td>Rp. <?= number_format($siswa['ukk']); ?></td>
                <td></td>
            </tr>
            <tr>
                <td align="center">8</td>
                <td>USEK + AKM (Asesment Kompetensi Minimum)</td>
                <td>Rp. <?= number_format($siswa['usek_akm']); ?></td>
                <td></td>
            </tr>
            <tr>
                <td align="center">9</td>
                <td>Sukses AKM (Asesment Kompetensi Minimum)</td>
                <td>Rp. <?= number_format($siswa['sukses_akm']); ?></td>
                <td></td>
            </tr>
            <tr>
                <td align="center">10</td>
                <td>Wisuda</td>
                <td>Rp. <?= number_format($siswa['wisuda']); ?></td>
                <td></td>
            </tr>
            <tr>
