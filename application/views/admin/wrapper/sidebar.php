            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('admin/absen'); ?>">Rekap Harian</a>
                        <a class="collapse-item" href="<?= base_url('admin/absen'); ?>">Rekap Bulanan</a>
                        <a class="collapse-item" href="<?= base_url('admin/absen'); ?>">Siswa</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
