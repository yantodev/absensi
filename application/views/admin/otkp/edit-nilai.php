    ...
    <div class="col-lg-8">
        <div class="card-body pb-0">
            ...
            <form action="" method="POST">
                ...
                <div class="form-group row">
                    <label for="nis" class="col-sm-4 col-form-label">Pengetikan Komputer</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="nis" class="col-sm-4 col-form-label">Persuratan / surat menyurat</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nilai_6" name="nilai_6" value="<?= $siswa['nilai_6']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nis" class="col-sm-4 col-form-label">Kearsipan</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="nis" class="col-sm-4 col-form-label">Kesekretariatan</label>
                    <div class="col-sm-8">
