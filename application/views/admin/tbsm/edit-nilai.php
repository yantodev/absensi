    ...
    <div class="col-lg-8">
        <div class="card-body pb-0">
            ...
            <form action="" method="POST">
                ...
                <div class="form-group row">
                    <label for="nis" class="col-sm-4 col-form-label">Merawat dan memperbaiki kerusakan engine</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="nis" class="col-sm-4 col-form-label">Memperbaiki kerusakan sistem kelistrikan</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nilai_6" name="nilai_6" value="<?= $siswa['nilai_6']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nis" class="col-sm-4 col-form-label">Memperbaiki kerusakan chasis</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="nis" class="col-sm-4 col-form-label">Melaksanakan K3</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nilai_8" name="nilai_8" value="<?= $siswa['nilai_8']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nis" class="col-sm-4 col-form-label">Kebersihan</label>
                    <div class="col-sm-8">
