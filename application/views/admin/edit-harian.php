                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="timestamp" id="timestamp"
                            value="<?= format_indo($data['timestamp']); ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">NBM</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="nbm" id="nbm" value="<?= $data['nbm']; ?>"
                            readonly>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="date_in" id="date_in"
                            value="<?= tgl($data['date_in']); ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
