            ...
            <table class="table table-bordered dataTab" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $d['status']; ?></td>
                        <td>
                            <button class="badge btn-primary" data-toggle="modal"
                                data-target="#EditModal<?= $d['id']; ?>"><i class="fa fa-edit fa-fw" alt="detail"
                                    title="Edit"></i> Edit</button>
                            <a href="<?= base_url(); ?>admin/hapus_dhkeg?id=<?= $d['id']; ?>&idkeg=<?= $id; ?>"><button
                                    class="badge btn-warning" onclick="return confirm('Yakin ingin menghapus?');"><i
                                        class="fa fa-trash fa-fw" alt="verifikasi" title="Hapus"></i> Hapus</button></a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
...
<?php $i = 0;
foreach ($data as $d) : $i++; ?>
<div class="modal fade" id="EditModal<?= $d['id']; ?>" tabindex="-1" aria-labelledby="NewRoleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/edit_dhkeg'); ?>" method="POST">
                <div class="form-group">
                    ...
                    <div class="col-lg">
                        <input class="form-control" type="text" id="kegiatan" name="kegiatan" value="<?= $d['nbm']; ?>"
                            readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg">
                        <input class="form-control" type="text" id="kegiatan" name="kegiatan" value="<?= $d['nama']; ?>"
                            readonly>
                    </div>
                </div>
                <div class="form-group">
...
$(document).ajaxComplete(getDetailEmployees(1288585))
</script>